function Header() {
  return (
    <div className="w-full bg-[#070524] h-62  place-content-center " data-aos="fade-up">
      <div className="w-full max-w-xl mx-auto px-4">
        <header className="border flex justify-center items-center h-16 gap-5 sm:gap-8 md:gap-10 text-white rounded-lg 
